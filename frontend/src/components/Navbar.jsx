    ...
    <>
      ...
      <nav className="bg-[#1e293b] border-b border-slate-700 px-4 md:px-8 py-3 flex items-center justify-between sticky top-0 z-50">
        <div className="flex items-center gap-4 md:gap-8">
          <h1 className="text-2xl font-bold text-[#00d1ff] tracking-tight cursor-pointer">
            Vingo
          </h1>
        ...
        <div className="flex items-center gap-3 md:gap-6">
          {userData.role == "owner" && (
            <>
              {myShopData && (
                <button
                  className="flex items-center justify-center p-2 rounded-full bg-[#ff4d2d]/10 text-[#eaede1] 
  sm:gap-2 sm:px-4"
                >
                  <FaPlus size={25} />
          ...
          {userData.role == "user" && (
            <button className="relative text-gray-300 hover:text-[#00d1ff]">
              ...
              <span className="absolute -top-2 -right-2 bg-[#00d1ff] text-[#0f172a] text-[10px] font-bold px-1.5 rounded-full">
                0
              </span>
            </button>
          )}
              ...
              <>
                ...
                <div className="absolute right-0 mt-3 w-64 bg-[#1e293b] border border-slate-700 rounded-2xl shadow-2xl z-50 py-2">
                  <div className="px-4 py-3 border-b border-slate-700">
                    ...
                    <p className="font-bold truncate text-[#00d1ff]">
                      {userData?.fullName || "Stuart Holder"}
                    </p>
                  ...
                  <div className="p-2">
                    <>
                      ...
                      <button
                        onClick={onLogout}
                        className="w-full flex items-center gap-3 px-3 py-2.5 text-sm rounded-xl hover:bg-red-500/10 text-red-400 mt-1"
                      >
                        <LogOut size={18} />
                        Logout
                      </button>
